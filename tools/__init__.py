...
from consts import TOOL_NAME, WRITE_TOOL_NAMES
...
from .preview import str_replace_preview, write_file_preview
...
# Write tool with write preview and waiting for users' approval
WRITE_TOOL = WRITE_TOOL_NAMES

# Tool cannot be run in parallel
TOOL_IN_SEQUENCE: list[TOOL_NAME] = [TOOL_NAME.WRITE_FILE_IN_SANDBOX, TOOL_NAME.STRING_REPLACE]

# Controls what `from tools import *` exposes — only the map, nothing else.
__all__ = ["TOOL_MAP", "tools", "WRITE_TOOL", "TOOL_IN_SEQUENCE"]
